...
public class DelateSubActivity extends Activity {
    ...
    private LinearLayout ll_add_sub_phone_one;
    private LinearLayout ll_add_sub_phone_two;
...
//                                    ((BaseActivity)getActivity()).goNextAnim();
        ...
        btn_sub_phone_add.setOnClickListener(new View.OnClickListener() {
            boolean clicked =false;
            @Override
            public void onClick(View view) {
                if (clicked==false){
                    ll_add_sub_phone_one.setVisibility(View.VISIBLE);
                    clicked=true;
                }else {
                    ll_add_sub_phone_two.setVisibility(View.VISIBLE);
                }
    ...
    private void init() {
        ...
        tv_sub_id = (TextView)findViewById(R.id.tv_sub_phone);
        ...
        ll_add_sub_phone_one = (LinearLayout) findViewById(R.id.ll_add_sub_phone_one);
        ll_add_sub_phone_two = (LinearLayout) findViewById(R.id.ll_add_sub_phone_two);
        ...
        btn_sub_phone_add = (Button) findViewById(R.id.btn_sub_phone_add);
