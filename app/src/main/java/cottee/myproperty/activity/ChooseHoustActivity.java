...
public class ChooseHoustActivity extends Activity {
    private Title title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_houst);
...
//        lv_show_house.setAdapter(chooseHouseAdapter);
        ...
        lv_show_house.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                LoginRegisterHandler loginRegisterHandler = new LoginRegisterHandler(ChooseHoustActivity.this, "", "");
                LoginRegisterManager loginRegisterManager = new LoginRegisterManager(ChooseHoustActivity.this, loginRegisterHandler);
                HouseListBean item = (HouseListBean) lv_show_house.getAdapter().getItem(i);
                loginRegisterManager.ChooseHouseForView(item.getHome_id());
            }
        });
    }
