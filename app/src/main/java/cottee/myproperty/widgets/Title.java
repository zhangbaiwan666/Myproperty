    ...
    private void refreshTheme(TitleTheme titleTheme){
        switch (titleTheme){
            case THEME_TRANSLATE:
                ...
                buttonHolderLeft.text.setTextColor(getResources().getColorStateList(R.color.transparentAA));
                buttonHolderRight1.text.setTextColor(getResources().getColorStateList(R.color.transparentAA));
                buttonHolderRight2.text.setTextColor(getResources().getColorStateList(R.color.transparentAA));
            ...
            case THEME_LIGHT:
                ...
                buttonHolderLeft.text.setTextColor(getResources().getColorStateList(R.color.Black));
                buttonHolderRight1.text.setTextColor(getResources().getColorStateList(R.color.Black));
                buttonHolderRight2.text.setTextColor(getResources().getColorStateList(R.color.Black));
                titleDivider.setBackgroundResource(R.color.Black);
