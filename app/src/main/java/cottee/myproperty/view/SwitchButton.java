...
/**
 * Created by Qiuyue on 2018/1/22.
 */
...
public class SwitchButton extends View {
    ...
    public static final int[] SwitchView = {0x7f0100ed, 0x7f0100ee, 0x7f0100ef, 0x7f0100f0, 0x7f0100f1, 0x7f0100f2, 0x7f0100f3, 0x7f0100f4, 0x7f0100f5};
    ...
    public SwitchButton(Context context, AttributeSet attrs) {
        ...
        final int DEFAULT_COLOR_PRIMARY = getResources().getColor(R.color.theme);
        final int DEFAULT_COLOR_PRIMARY_DARK = getResources().getColor(R.color.theme);

        TypedArray a = context.obtainStyledAttributes(attrs, SwitchView);
        colorPrimary = a.getColor(SwitchView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(SwitchView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorOff = a.getColor(SwitchView_offColor, getResources().getColor(R.color.gray3));
        colorOffDark = a.getColor(SwitchView_offColorDark, getResources().getColor(R.color.gray3));
        colorShadow = a.getColor(SwitchView_shadowColor, getResources().getColor(R.color.gray3));
        ratioAspect = a.getFloat(SwitchView_ratioAspect, 0.68f);
        hasShadow = a.getBoolean(SwitchView_hasShadow, false);
        isOpened = a.getBoolean(SwitchView_isOpened, true);
    ...
    private void toggleSwitch(boolean isOpened) {
        int wishState = isOpened ? STATE_SWITCH_ON : STATE_SWITCH_OFF;
        if (wishState == state) {
            return;
        }
